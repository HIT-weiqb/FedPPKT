...
def vgg8_bn(args):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(cfg['S'], args, batch_norm=True)
    return model
...
def vgg11(args):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(cfg['A'], args)
    return model


def vgg11_bn(args):
    """VGG 11-layer model (configuration "A") with batch normalization"""
    model = VGG(cfg['A'], args, batch_norm=True)
    return model
...
def vgg13(args):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(cfg['B'], args)
    return model


def vgg13_bn(args):
    """VGG 13-layer model (configuration "B") with batch normalization"""
    model = VGG(cfg['B'], args, batch_norm=True)
    return model
...
def vgg16(args):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(cfg['D'], args)
    return model


def vgg16_bn(args):
    """VGG 16-layer model (configuration "D") with batch normalization"""
    model = VGG(cfg['D'], args, batch_norm=True)
    return model
...
def vgg19(args):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(cfg['E'], args)
    return model


def vgg19_bn(args):
    """VGG 19-layer model (configuration 'E') with batch normalization"""
    model = VGG(cfg['E'], args, batch_norm=True)
    return model
